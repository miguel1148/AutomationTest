...
/**
10) Clique na guia Descrição do livro em que você clicou.
11) Deve haver uma descrição sobre o livro em que o usuário clicou
12)Agora, acesse a guia "Reviews" do livro em que você clicou.
11) Deve haver um comentário sobre o livro em que o usuário clicou
 * @author Coolbrain_dev
 *
 */
public class VerifyElements {
	...
	public VerifyElements(WebDriver driver, WebDriverWait wait) {
		this.driver = driver;
		this.wait = wait;
	}
